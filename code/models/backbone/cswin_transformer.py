...
class CSWin(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=64, depth=[1,2,21,1], split_size = 7,
        ...
        self.stage1 = nn.ModuleList([
            CSWinBlock(
                dim=curr_dim, num_heads=heads[0], patches_resolution=img_size//4, mlp_ratio=mlp_ratio,
        ...
        self.stage2 = nn.ModuleList(
            [CSWinBlock(
                dim=curr_dim, num_heads=heads[1], patches_resolution=img_size//8, mlp_ratio=mlp_ratio,
        ...
        temp_stage3.extend(
            [CSWinBlock(
                dim=curr_dim, num_heads=heads[2], patches_resolution=img_size//16, mlp_ratio=mlp_ratio,
...
#     model = CSWin(img_size=512, split_size=[1,2,7,7],num_heads=[2,4,8,16])
...
def CSWin_tiny():
    model = CSWin(patch_size=4, embed_dim=64, depth=[1,2,21,1], img_size=512,
        split_size=[1,2,7,7], num_heads=[2,4,8,16], mlp_ratio=4.)
    return model

def CSwin_small():
    model = CSWin(patch_size=4, embed_dim=64, depth=[2,4,32,2], img_size=512,
        split_size=[1,2,7,7], num_heads=[2,4,8,16], mlp_ratio=4.)
    return model

def CSwin_base():
    model = CSWin(patch_size=4, embed_dim=96, depth=[2,4,32,2], img_size=512,
